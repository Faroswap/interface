...
export default function Total({
  ...
  const [pointTab, setPointTab] = useState(PointTab.trading);
...
function DashboardItem({
  ...
  return (
    <div
      className="relative flex rounded-lg flex-1 items-center px-5 py-3 bg-main hover:shadow-[0_4px_8px_0_rgba(0,0,0,0.12)] group cursor-pointer"
      onClick={() => onClick()}
    >
      ...
      <ArrowRight className="absolute top-5 right-5 text-secondary group-[:not(:hover)]:hidden" />
    </div>
  );
}
