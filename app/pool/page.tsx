...
export default function PoolPage({
  ...
  return (
    <div
      className="pb-10 overflow-y-auto flex flex-col md:[&_.widget-module-container]:p-0 md:[&_.widget-module-container]:pl-5 max-md:[&_.widget-module-container]:h-max  [&_.widget-module-container]:overflow-visible md:[&_.widget-module-container]:max-h-full"
      ref={scrollRef}
    >
      <PoolBanner />
      <Widget>
