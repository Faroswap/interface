...
export type Query = {
  ...
  >;
  sigmax_limit_getPendingOrderChainList?: Maybe<
    Array<Maybe<Scalars['Int']['output']>>
  >;
...
export type FetchPointsHistoryQuery = {
  points_activity_history?: {
    page?: number | null;
    count?: number | null;
...
export type FetchPointsLeaderboardQueryVariables = Exact<{
  where?: InputMaybe<Points_ActivityleaderboardFilter>;
}>;

export type FetchPointsLeaderboardQuery = {
  points_activity_leaderboard?: {
    overallRanks?: Array<{
...
export type FetchPointsUserSummaryQuery = {
...
export type FetchBrandAnnouncementListQueryVariables = Exact<{
  where?: InputMaybe<Brand_Site_Announcementqueryilter>;
}>;

export type FetchBrandAnnouncementListQuery = {
  brand_site_announcement_list?: {
    lastPublishId?: number | null;
...
export type FetchBrandSiteBannerListQueryVariables = Exact<{
  where?: InputMaybe<Brand_Site_Bannerqueryilter>;
}>;

export type FetchBrandSiteBannerListQuery = {
  brand_site_banner_list?: Array<{
    id?: number | null;
    title?: string | null;
...
export const FetchPointsHistoryDocument = new TypedDocumentString(`
  ...
  points_activity_history(where: $where) {
    ...
    `) as unknown as TypedDocumentString<
  FetchPointsHistoryQuery,
  FetchPointsHistoryQueryVariables
>;
export const FetchPointsLeaderboardDocument = new TypedDocumentString(`
...
export const FetchPointsUserSummaryDocument = new TypedDocumentString(`
  ...
  points_activity_userSummary(where: $where) {
    ...
    `) as unknown as TypedDocumentString<
  FetchPointsUserSummaryQuery,
  FetchPointsUserSummaryQueryVariables
>;
export const FetchBrandAnnouncementListDocument = new TypedDocumentString(`
  ...
  brand_site_announcement_list(where: $where) {
    ...
    `) as unknown as TypedDocumentString<
  FetchBrandAnnouncementListQuery,
  FetchBrandAnnouncementListQueryVariables
>;
export const FetchBrandSiteBannerListDocument = new TypedDocumentString(`
  ...
  brand_site_banner_list(where: $where) {
    ...
    `) as unknown as TypedDocumentString<
  FetchBrandSiteBannerListQuery,
  FetchBrandSiteBannerListQueryVariables
>;
